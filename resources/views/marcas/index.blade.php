                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('marcas.destroy',$paginacion->id_mar) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('marcas.show',$paginacion->id_mar) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('marcas.edit',$paginacion->id_mar) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
